...
| Desiccant + breather vent | Enclosure moisture control; **reusable** — regenerated in the **box solar oven** (no discard) | TBD | REQ-CTRL-5, REQ-CYCLE-9 | TBD | TBD | TBD | TBD | proposed | Pairs w/ breather membrane; solar-regen = produce-no-waste + a solar-thermal lesson |
