...
| Sump / dewatering pump *(contingency)* | **DC bilge pump ~1100 GPH, 12/24 V submersible + float switch** *or equal* | 0–1 | REQ-SLAB-2, REQ-WATER-2 | TBD | TBD | TBD | TBD | proposed | **Low-head only** — *can't* lift to the tower (that's the HYSKY). For a sub-grade floor-drain sump that can't gravity-drain, or a flood-evac failsafe. Float-switched (mechanical, foolproof), intermittent ~40–50 W; negligible daily energy |
